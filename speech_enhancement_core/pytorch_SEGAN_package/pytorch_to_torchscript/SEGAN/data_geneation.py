...
if __name__ == "__main__":
    clean_wav_path = "./dataset/clean_trainset_wav"
    noisy_wav_path = "./dataset/noisy_trainset_wav"
    
    catch_train_clean = './ctach_segan/clean'
    catch_train_noisy = './ctach_segan/noisy'
